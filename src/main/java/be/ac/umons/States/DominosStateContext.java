...
public class DominosStateContext {

        private DominosState state;

        public DominosStateContext(){
            //Etat par défaut
            state = new DominosWaitingState();
        }
    public boolean check(Map<String, String> commandes){
        ...
        public void setState(DominosState newState){
            state = newState;
        }
